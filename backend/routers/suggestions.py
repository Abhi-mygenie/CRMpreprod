...
async def order_suggestions(
    ...
    # CR-077: fetch loyalty_settings for configurable band thresholds
    settings_doc = await db.loyalty_settings.find_one({"user_id": user_id}, {"_id": 0}) or {}
    tasks = [
    ...
    if not is_first_time:
        tasks.append(compute_customer_value(db, user_id, customer_id, customer, settings_doc))  # CR-077
