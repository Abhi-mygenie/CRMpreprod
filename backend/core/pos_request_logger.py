...
def load_config() -> dict:
    ...
    return {
        ...
        "path_prefix": os.environ['POS_REQUEST_LOGGING_PATH_PREFIX'],
        "body_max_bytes": int(os.environ['POS_REQUEST_LOGGING_BODY_MAX_BYTES']),
        "ttl_days": int(os.environ['POS_REQUEST_LOGGING_TTL_DAYS']),
        ...
        "sample_rate": float(os.environ['POS_REQUEST_LOGGING_SAMPLE_RATE']),
    }
