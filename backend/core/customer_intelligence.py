...
async def compute_customer_value(db, user_id: str, customer_id: str, customer: dict) -> Optional[dict]:
    ...
    churn_score = await _compute_churn_risk(db, user_id, customer_id, customer, days_since_last, freq_per_month)
...
async def _compute_churn_risk(db, user_id: str, customer_id: str, customer: dict,
                               days_since_last: int, freq_per_month: float) -> float:
