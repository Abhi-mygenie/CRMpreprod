...
export default function CustomerLifecyclePage() {
    ...
    // CR-076 E-C: Re-engage modal state
    ...
    // CR-076 E-C.2: Fix dead Re-engage button — open inline modal instead of navigating
    const handleReengage = async (customerId) => {
        ...
        if (reengageTemplates.length === 0) {
            ...
            } catch { /* silent — templates load fails quietly */ }
        }
    };

    // CR-076 E-C.3: Send re-engagement WhatsApp via DirectSend path
    ...
    return (
        <ResponsiveLayout>
                    ...
                    <CardHeader className="pb-2">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                            ...
                            <div className="flex gap-2">
                                ...
                                {/* CR-076 E-C.5: Bulk Re-engage CTA — visible when actionable stage selected */}
            ...
            {/* CR-076 E-C.4: Per-row Re-engage Modal */}
