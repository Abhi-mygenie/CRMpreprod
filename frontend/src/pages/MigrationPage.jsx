                            ...
                            <CardContent className="p-4">
                                <div className="flex items-center justify-between mb-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            {migrationStatus?.customer_sync_breakdown && (migrationStatus.customer_sync_breakdown.duplicates_merged > 0 || migrationStatus.customer_sync_breakdown.failed > 0) && (
                                                <p className="text-[11px] text-[#52525B] mt-1 leading-tight" data-testid="customer-sync-breakdown">
                                    ...
                                    {migrationStatus?.customers_synced > 0 && (
                                        <Badge className="bg-green-100 text-green-700 border-0" data-testid="customer-sync-summary">
                            ...
                            <CardContent className="p-4">
                                <div className="flex items-center justify-between mb-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            {migrationStatus?.order_sync_breakdown && (migrationStatus.order_sync_breakdown.duplicates_merged > 0 || migrationStatus.order_sync_breakdown.failed > 0) && (
                                                <p className="text-[11px] text-[#52525B] mt-1 leading-tight" data-testid="order-sync-breakdown">
                                    ...
                                    {migrationStatus?.orders_synced > 0 && (
                                        <Badge className="bg-green-100 text-green-700 border-0" data-testid="order-sync-summary">
