...
import { 
    ...
    Wallet, UserPlus, Megaphone, History, UsersRound
} from "lucide-react";
...
export const ResponsiveLayout = ({ children }) => {
    ...
    const whatsappChildPaths = ["/settings", "/templates", "/whatsapp-automation"];
    const marketingChildPaths = ["/campaigns", "/audiences", "/campaign-history"];
    ...
    const isMarketingChildActive = marketingChildPaths.includes(location.pathname) || location.pathname.startsWith("/campaigns/");
    ...
    const navItems = [
        ...
        },
        {
            ...
            children: [
                ...
                { path: "/audiences", icon: UsersRound, label: "Audiences" },
                { path: "/campaign-history", icon: History, label: "History" },
            ]
        },
        { 
            icon: BarChart3, 
    ...
    const isGroupExpanded = (group) => {
        ...
        if (group === "marketing") return isMarketingChildActive;
