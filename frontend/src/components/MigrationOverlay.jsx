                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    {migrationStatus?.customers_synced > 0 && (
                                        <p className="text-xs text-[#329937] flex items-center gap-1 font-body" data-testid="customer-sync-summary">
                                    ...
                                    {migrationStatus?.customer_sync_breakdown && (migrationStatus.customer_sync_breakdown.duplicates_merged > 0 || migrationStatus.customer_sync_breakdown.failed > 0) && (
                                        <p className="text-[11px] text-[#52525B] mt-0.5 font-body leading-tight" data-testid="customer-sync-breakdown">
                                            {migrationStatus.customer_sync_breakdown.duplicates_merged > 0 && (
                                                <span>{migrationStatus.customer_sync_breakdown.duplicates_merged.toLocaleString()} duplicate{migrationStatus.customer_sync_breakdown.duplicates_merged === 1 ? '' : 's'} merged (same phone)</span>
                                            )}
                                            {migrationStatus.customer_sync_breakdown.failed > 0 && (
                                                <span className="text-red-600">{migrationStatus.customer_sync_breakdown.duplicates_merged > 0 ? ' · ' : ''}{migrationStatus.customer_sync_breakdown.failed.toLocaleString()} failed</span>
                                            )}
                                        </p>
                                    )}
                                </div>
                        ...
                        <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    {migrationStatus?.orders_synced > 0 && (
                                        <p className="text-xs text-[#329937] flex items-center gap-1 font-body" data-testid="order-sync-summary">
                                    ...
                                    {migrationStatus?.order_sync_breakdown && (migrationStatus.order_sync_breakdown.duplicates_merged > 0 || migrationStatus.order_sync_breakdown.failed > 0) && (
                                        <p className="text-[11px] text-[#52525B] mt-0.5 font-body leading-tight" data-testid="order-sync-breakdown">
                                            {migrationStatus.order_sync_breakdown.duplicates_merged > 0 && (
                                                <span>{migrationStatus.order_sync_breakdown.duplicates_merged.toLocaleString()} re-synced (updated)</span>
                                            )}
                                            {migrationStatus.order_sync_breakdown.failed > 0 && (
                                                <span className="text-red-600">{migrationStatus.order_sync_breakdown.duplicates_merged > 0 ? ' · ' : ''}{migrationStatus.order_sync_breakdown.failed.toLocaleString()} failed</span>
                                            )}
                                        </p>
                                    )}
                                </div>
