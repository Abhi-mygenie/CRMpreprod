...
import { MessageSquare, Settings, Plus, Check, X, Trash2, Eye, ChevronLeft, KeyRound, Pause, Play, Send, FlaskConical, Lock, ExternalLink } from "lucide-react";
    ...
    const handleSendTest = async () => {
        ...
        try {
            ...
            const response = await api.post("/whatsapp/test-template", {
                ...
                ...(hasButtonValues ? { button_values: buttonValues } : {}),
            });
                                                                        ...
                                                                        <div className="flex-1">
                                                                            ...
                                                                            {(() => {
                                                                                ...
                                                                                if (tpl && tpl.temp_status === 3) return (
                                                                                    <p className="text-xs ml-6 text-red-500 font-medium mt-0.5" data-testid={`rejected-warning-${eventKey}`}>This template was rejected by Meta and cannot deliver messages</p>
                                                                                );
                                                                                if (tpl && tpl.temp_status === 4) return (
                                                                                    <p className="text-xs ml-6 text-amber-500 font-medium mt-0.5" data-testid={`pending-warning-${eventKey}`}>This template is pending Meta approval</p>
                                                                                );
                                                                                return null;
                                                                            })()}
