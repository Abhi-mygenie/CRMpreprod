    ...
    for (const [absPath, cached] of FILE_AST_CACHE) {
      ...
      traverse(ast, {
        ImportDeclaration(importPath) {
          ...
          const searchRoot = importPath.parentPath && importPath.parentPath.parentPath
            ? importPath.parentPath.parentPath
            : importPath.parentPath;
          if (!searchRoot || typeof searchRoot.traverse !== "function") return;
          searchRoot.traverse({
            JSXOpeningElement(jsxPath) {
              if (result) return;
