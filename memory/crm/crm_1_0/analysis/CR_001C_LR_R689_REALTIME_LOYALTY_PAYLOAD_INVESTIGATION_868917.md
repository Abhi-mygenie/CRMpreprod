...
> **⚠️ SUPERSEDED 2026-05-26.** POS team has since shipped the contract fixes; live `/api/pos/orders` payloads now carry top-level `loyalty_points_used` and customer identifiers. See `qa/CR_001C_LR_REALTIME_ORDER_REDEMPTION_CLOSURE_2026_05_26.md` and `handoff/CR_001C_POS_CONTRACT_COMPLIANCE_CLOSURE_2026_05_26.md`. Preserved for history.
