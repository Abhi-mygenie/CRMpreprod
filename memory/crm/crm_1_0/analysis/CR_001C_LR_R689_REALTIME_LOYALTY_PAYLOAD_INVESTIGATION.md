...
> **⚠️ SUPERSEDED 2026-05-26.** The findings below ("POS never POSTed to a CRM endpoint", "payload missing loyalty fields") are obsolete. POS team has since shipped the contract fixes; live `/api/pos/orders` payloads on R689 now carry all required top-level fields and 76 redeem PT rows have been committed (8,633 pts redeemed).
>
> See:
