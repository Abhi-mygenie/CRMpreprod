...
POS may run their own integration tests against the preview origin (`https://pos-coupon-test.preview.emergentagent.com`). All redeem paths are idempotent — replaying the same order is safe.
