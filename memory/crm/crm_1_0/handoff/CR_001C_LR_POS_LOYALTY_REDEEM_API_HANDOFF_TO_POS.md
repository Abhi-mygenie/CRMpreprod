...
**Preview origin:** `https://pos-coupon-test.preview.emergentagent.com`

Full URL in preview:

```
https://pos-coupon-test.preview.emergentagent.com/api/pos/loyalty/redeem
```
...
```bash
curl -X POST 'https://pos-coupon-test.preview.emergentagent.com/api/pos/loyalty/redeem' \
