...
> **⚠️ SUPERSEDED 2026-05-26.** All 7 violations listed below have been resolved in production. POS team shipped the contract fixes. Live-DB verification on 2026-05-26 confirms 15 / 15 most-recent `/api/pos/orders` payloads are contract-compliant (top-level `loyalty_points_used`, top-level `coupon_code`, item-level `pos_food_id`, top-level `wallet_used`, zero nested wrappers).
>
> **Closure doc:** `handoff/CR_001C_POS_CONTRACT_COMPLIANCE_CLOSURE_2026_05_26.md`
> **Closure status:** `cr001c_pos_contract_compliance_closed_pos_shipped_2026_05_26`
>
> This file is preserved for history. **Do not act on its "POS Team Action Required" section** — those actions have already been taken.

**Date:** 2026-05-25
**Status:** `cr001c_pos_contract_compliance_violations_reported_waiting_pos_fix` *(superseded)*
