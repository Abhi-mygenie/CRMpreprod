...
| 29 | `CR-079 POS Customer Edit — Contract Fix` | Fix — schema + response shape | Intake: `../discovery/CR_079_POS_CUSTOMER_EDIT_INTAKE.md` | `cr079_impact_analysis_complete_ready_for_impl_plan` |
| 30 | `CR-080 POS Loyalty & Wallet Management` | New feature — POS auth wrappers + financial writes | Intake: `../discovery/CR_080_POS_LOYALTY_WALLET_INTAKE.md` | `cr080_impact_analysis_complete_ready_for_impl_plan` |
| 31 | `CR-081 POS Coupon Management` | New feature — POS auth wrappers + net-new distribute | Intake: `../discovery/CR_081_POS_COUPON_MANAGEMENT_INTAKE.md` | `cr081_impact_analysis_complete_ready_for_impl_plan` |
