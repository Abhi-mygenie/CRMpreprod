...
| 4 | `CR-003 Coupon Analytics Dashboard` | **Phase 4 Owner Verified — ROI Score (QA docs missing for P3+P4)** | `./implementation/CR_003_COUPON_ANALYTICS_DASHBOARD_PHASE_4_IMPLEMENTATION_REPORT.md` |
| 5 | `CR-004 WhatsApp Utility + Marketing Message Integration` | **Phase 2.5-B Implemented — Coupon Picker in Variable Mapping Modal** | `./implementation/CR_004_PHASE_2_5B_COUPON_AWARE_DYNAMIC_VARIABLE_MAPPING_IMPLEMENTATION_REPORT.md` |
...
| 12 | `CR-012 WhatsApp Template Builder Production Readiness` | **Registered — Discovery Complete (16 gaps, 3 phases)** | `./discovery/CR_012_WHATSAPP_TEMPLATE_BUILDER_PRODUCTION_READINESS_DISCOVERY.md` |
| 13 | `CR-013 WhatsApp Template Gallery (Pre-Built Restaurant Templates)` | **Registered — Awaiting Discovery (blocked by CR-012 P1)** | `./discovery/CR_013_WHATSAPP_TEMPLATE_GALLERY_DISCOVERY.md` |
