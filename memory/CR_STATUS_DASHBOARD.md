...
| **035** | **Customer List Export & Import** | **📋 Registered — Discovery blocked on Q1-Q6** | **📋** | ~8-10 hrs (both) | Zero code exists. Export = download CSV/Excel of customer list (filtered or all). Import = upload CSV/Excel to bulk-create/update customers. **Blockers Q1-Q6:** format (CSV/Excel?), fields subset, duplicate phone handling (skip/update/error), mandatory fields, row limit. Intake: `discovery/CR_035_CUSTOMER_EXPORT_IMPORT_INTAKE.md`. | **2026-07-01** |
