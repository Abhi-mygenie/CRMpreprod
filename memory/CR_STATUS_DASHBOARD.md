...
| **017** | **/pos/max-redeemable Missing Projected Points Earned** | **Discovery complete — awaiting owner approval** | **⏸** | ~30 min | Hot production fix. Add `projected_points_earned` + `projected_earn_percent` to max-redeemable response. Single endpoint, additive, non-breaking. | **2026-05-29** |
...
| Date | CR | From → To |
|---|---|---|
| 2026-05-29 | **CR-017** | — → ⏸ **REGISTERED + Discovery complete**. Hot production fix: `/pos/max-redeemable` missing `projected_points_earned`. Awaiting owner approval. |
